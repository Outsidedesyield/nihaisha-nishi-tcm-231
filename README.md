...
```bash
git clone https://github.com/Outsidedesyield/nihaisha-nishi-tcm-231.git
cd nihaisha-nishi-tcm-231
python setup.py
```
...
[![GitHub stars](https://img.shields.io/github/stars/JuneYaooo/nihaisha-tcm?style=flat)](https://github.com/Outsidedesyield/nihaisha-nishi-tcm-231/stargazers)
...
```text
帮我安装 nihaisha skill：
https://github.com/Outsidedesyield/nihaisha-nishi-tcm-231
```
...
```bash
git clone git@github.com:Outsidedesyield/nihaisha-nishi-tcm-231.git
cd nihaisha-tcm
...
<!-- Last updated: 2026-06-06 15:44:53 -->
